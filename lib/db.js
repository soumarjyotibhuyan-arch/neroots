...
const INITIAL_ORDERS = [
  {
    ...
    cart: [
      ...
      { id: 2, name: "NE Roots Assam Nemu Lime Pickle", weight: "250g", price: 249, quantity: 1, image: "/images/kazi_nemu_pickle.jpg" }
    ],
    status: "Delivered",
...
const INITIAL_REVIEWS = [
  ...
  },
  {
    ...
    rating: 5,
    flavour: "Assam Nemu King Lime Pickle",
    title: "Best Nemu pickle in India! That floral citrus aroma is heavenly",
    comment: "I live away from Assam and missed Nemu terribly. The moment I opened the jar, the fragrance filled my kitchen. The mustard seed paste and soft peel are pure perfection. Delivered in 3 days safely!",
    date: "2026-08-20",
    verifiedPurchase: true
  },
  {
