...
const INITIAL_PRODUCTS = [
  ...
  {
    id: 2,
    name: "NE Roots Assam Kazi Nemu (King Lime) & Mustard Oil Pickle",
    shortName: "Assam Kazi Nemu Lime",
    category: "Tangy & Aromatic",
    price: 249,
    prices: { "250g": 249, "500g": 449, "1kg": 799 },
    description: "Geographical Indication (GI) tagged Assam Kazi Nemu lemons known for their intense floral citrus aroma, cured in golden yellow mustard paste, organic turmeric, and cold-pressed oil.",
    spiceLevel: "Mild",
    spiceRating: 1,
    image: "/images/kazi_nemu_pickle.jpg",
    badge: "GI Tagged Assam Lemon 🍋",
    origin: "Golaghat, Assam",
    ingredients: ["Fresh Assam Kazi Nemu (King Lemon)", "Yellow Mustard Paste", "Mustard Oil", "Turmeric", "Green Chilli", "Black Salt", "Ajwain"],
    rating: 4.95,
    reviewCount: 186,
    inStock: true,
    featured: true
...
const INITIAL_ORDERS = [
  {
    ...
    address: "Flat 402, Lotus Residency, Indiranagar, Bengaluru, 560038",
    ...
    total: 748,
    cart: [
      { id: 1, name: "NE Roots Assam Bhut Jolokia & Bamboo Shoot Pickle", weight: "500g", price: 549, quantity: 1, image: "/images/bhut_jolokia_pickle.jpg" },
      { id: 2, name: "NE Roots Assam Kazi Nemu Lime Pickle", weight: "250g", price: 249, quantity: 1, image: "/images/kazi_nemu_pickle.jpg" }
    ],
    status: "Delivered",
  ...
  },
  {
    ...
    address: "Plot 18, Banjara Hills Road No 12, Hyderabad, 500034",
    ...
    total: 519,
    cart: [
      { id: 3, name: "NE Roots Sikkim Dalle Khursani Round Cherry Chilli Pickle", weight: "500g", price: 519, quantity: 1, image: "/images/dalle_khursani_pickle.jpg" }
    ],
    status: "Shipped",
...
const INITIAL_REVIEWS = [
  {
    ...
    rating: 5,
    flavour: "Assam Bhut Jolokia & Bamboo Shoot Pickle",
    title: "Authentic Khorisa taste! Reminds me of home in Tezpur",
    comment: "The pungency of the mustard oil and the authentic fermented bamboo shoot aroma is unmatched. Usually commercial brands don't get the Khorisa balance right, but NE Roots nailed the grandmother's touch!",
    date: "2026-08-22",
    verifiedPurchase: true
  },
  {
    id: 2,
    author: "Dr. Malavika Saikia",
    location: "Bengaluru, Karnataka",
    rating: 5,
    flavour: "Assam Kazi Nemu King Lime Pickle",
    title: "Best Kazi Nemu pickle in India! That floral citrus aroma is heavenly",
    comment: "I live away from Assam and missed Kazi Nemu terribly. The moment I opened the jar, the fragrance filled my kitchen. The mustard seed paste and soft peel are pure perfection. Delivered in 3 days safely!",
    date: "2026-08-20",
    verifiedPurchase: true
  },
  {
    ...
    rating: 5,
    flavour: "Sikkim Dalle Khursani Round Cherry Chilli",
    title: "Fiery punch with intense flavor! Must-try for chilli lovers",
    comment: "Dalle Khursani is difficult to find outside Sikkim/Darjeeling. The whole cherry chillies bursting with mustard oil and fenugreek elevate plain dal-rice to gourmet status.",
    date: "2026-08-18",
    verifiedPurchase: true
  },
  {
    ...
    rating: 5,
    flavour: "Wild Hill Garlic & Mustard Seed Achaar",
    title: "Super flavorful and not overly sour like mass market pickles",
    comment: "The garlic cloves are tender and soaked in rich cold-pressed mustard oil. You can genuinely taste that there are zero artificial preservatives.",
    date: "2026-08-15",
    verifiedPurchase: true
  },
  {
    id: 5,
    author: "Prateek Barua",
    location: "Delhi NCR",
    rating: 5,
    flavour: "Sun-Cured Raw Mango & Bhoot Jolokia Fusion",
    title: "The Ghost Pepper kick is brilliant!",
    comment: "Traditional mango achaar with that subtle, building heat of King Chilli. Loved the packaging and the glass jar quality.",
    date: "2026-08-12",
    verifiedPurchase: true
  }
];
...
const INITIAL_TEAM = [
  {
    ...
    bio: "Passionate about preserving indigenous culinary traditions of Assam and scaling North Eastern FMCG treasures across India and the globe. Leading brand strategy and supply-chain logistics.",
  ...
  },
  {
    id: 2,
    name: "Ananya Dutta",
    role: "Master Food Technologist & Kitchen Lead",
  ...
  {
    id: 3,
    name: "Rupjyoti Kalita",
    role: "Head of Farmer Partnerships & Sourcing",
    bio: "Directly partnering with smallholder farming clusters in Tezpur and Golaghat for fresh Bhut Jolokia, organic Kazi Nemu lemons, and wild mountain garlic, ensuring fair trade and zero middlemen.",
    image: "/images/ner_logo_icon.jpg",
...
const INITIAL_ADMIN_USERS = [
  {
    email: "admin@neroots.in",
    name: "NE Roots Founder",
    role: "Owner / Super Admin",
    avatar: "/images/ner_logo_icon.jpg",
    addedAt: "2026-08-25",
    isGoogleVerified: true
  },
  {
    email: "admin@nanirasoi.com",
